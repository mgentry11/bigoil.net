...
class CloudSyncManager: ObservableObject {
    ...
    private func uploadBodyMeasurements() async throws {
        ...
        for measurement in measurements {
            ...
            record["weight"] = measurement.weight ?? 0
            ...
            record["biceps"] = measurement.biceps ?? 0
            record["thighs"] = measurement.thighs ?? 0
    ...
    private func bodyMeasurement(from record: CKRecord) -> BodyMeasurement? {
        ...
        let biceps = record["biceps"] as? Double
        let thighs = record["thighs"] as? Double
        ...
        return BodyMeasurement(
            ...
            biceps: biceps == 0 ? nil : biceps,
            thighs: thighs == 0 ? nil : thighs,
            profile: profile
        )
    }
