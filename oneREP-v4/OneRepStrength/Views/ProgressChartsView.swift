...
//  HITCoachPro
//
//  Displays progress charts and detailed statistics (Renamed to StatsView for v3)
//

import SwiftUI
import Charts

struct StatsViewLegacy: View {
    @EnvironmentObject var workoutManager: WorkoutManager
    @ObservedObject var logManager = WorkoutLogManager.shared
    @State private var selectedExercise: String?
    @State private var selectedTab: StatsTab = .charts
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            ScrollView {
                ...
                .padding(.bottom, 120) // Floating menu spacing
            }
        }
