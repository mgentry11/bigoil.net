...
struct Exercise: Identifiable, Codable, Hashable {
    ...
    var isLogged: Bool = false       // Whether this exercise has been logged to history
    ...
    var isNegativeOnly: Bool = false // Feature: Negative resistance only (sustained eccentric)
    var youtubeURL: String?          // Optional YouTube video URL for exercise demonstration

    init(id: UUID = UUID(), name: String, iconName: String, audioFileName: String, lastWeight: Double? = nil, isBodyweight: Bool = false, isNegativeOnly: Bool = false, youtubeURL: String? = nil) {
        self.id = id
        self.name = name
        ...
        self.isNegativeOnly = isNegativeOnly
