...
// Note: Apple requires \(.applicationName) in every phrase.
// The app display name is "One Rep" which Siri understands better than "OneRepStrength"
struct OneRepStrengthShortcuts: AppShortcutsProvider {
    static var appShortcuts: [AppShortcut] {
        ...
        AppShortcut(
            ...
            phrases: [
                "Start \(\.$exercise) in \(.applicationName)",
                "\(.applicationName) start \(\.$exercise)",
                "Do \(\.$exercise) with \(.applicationName)"
            ],
        ...
        AppShortcut(
            ...
            phrases: [
                "Skip phase in \(.applicationName)",
                "\(.applicationName) skip",
                "Next phase in \(.applicationName)"
            ],
        ...
        AppShortcut(
            ...
            phrases: [
                "Start leg press in \(.applicationName)",
                "\(.applicationName) leg press",
                "Do leg press with \(.applicationName)"
            ],
        ...
        AppShortcut(
            ...
            phrases: [
                "Start chest press in \(.applicationName)",
                "\(.applicationName) chest press",
                "Do chest press with \(.applicationName)"
            ],
