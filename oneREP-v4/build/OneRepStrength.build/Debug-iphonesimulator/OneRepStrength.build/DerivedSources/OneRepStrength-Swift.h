...
#ifndef ONEREPSTRENGTH_SWIFT_H
#define ONEREPSTRENGTH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OneRepStrength",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14OneRepStrength11AppDelegate")
...
@class AVAudioPlayer;
SWIFT_CLASS("_TtC14OneRepStrength12AudioManager")
@interface AudioManager : NSObject <AVAudioPlayerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer * _Nonnull)player successfully:(BOOL)flag;
@end

SWIFT_CLASS("_TtC14OneRepStrength24WatchConnectivityManager")
...
@class WCSession;
@class NSString;
@interface WatchConnectivityManager (SWIFT_EXTENSION(OneRepStrength)) <WCSessionDelegate>
