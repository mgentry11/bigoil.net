            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        Text("Just say these to Siri - no setup needed!")
                            .font(.caption)
                            .foregroundColor(.gray)
                            .padding(.horizontal)
                        ...
                        VStack(spacing: 12) {
                            SiriPhraseCard(
                                phrase: "Hey Siri, start my push workout",
                                description: "Starts Workout A"
                            )
                            SiriPhraseCard(
                                phrase: "Hey Siri, start my pull workout",
                                description: "Starts Workout B"
                            )
                            SiriPhraseCard(
                                phrase: "Hey Siri, quick start workout",
                                description: "Starts your current workout"
                            )
                        }
                    }
                    .padding(.top, 8)
...
struct EditProfileSheet: View {
    ...
    var routineExplanation: String {
        ...
        case .beginner:
            return "Focus on learning proper form and building a foundation. One workout type ensures you master the basics before adding variety."
        case .intermediate:
            return "Alternating workouts provides balanced development across all muscle groups while allowing adequate recovery."
        case .advanced:
            return "Higher frequency supports continued progress. The A/B/A pattern one week, then B/A/B the next ensures equal attention to all exercises."
        }
    }
