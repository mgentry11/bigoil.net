...
class WorkoutScheduler: ObservableObject {
    ...
    func calculateNextWorkout(
        ...
        if notificationsEnabled {
            scheduleWorkoutNotification(for: nextDate, profile: profile)
        }
    ...
    func scheduleWorkoutNotification(for date: Date, profile: Int) {
        ...
        content.body = "Your workout is scheduled for today. Let's crush it!"
    ...
    func setNextWorkoutDate(_ date: Date, profile: Int) {
        let calendar = Calendar.current
        let today = calendar.startOfDay(for: Date())
        ...
        if notificationsEnabled {
            scheduleWorkoutNotification(for: selectedDay, profile: profile)
        }
